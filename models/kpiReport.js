...
module.exports = {
    ...
    water_discharge_by_destination: async (facilities, year, finalyeardata) => {
        ...
        if (finalyeardata == '2') {
            where += ` and  B.month IN ("Apr","May","Jun","July","Aug","Sep","Oct","Nov","Dec","Jan","Feb","Mar") and  B.month !="" GROUP BY B.month`
        } else {
            where += ` and  B.month IN ("Jan","Feb","Mar","Apr","May","Jun","July","Aug","Sep","Oct","Nov","Dec") and  B.month !="" GROUP BY B.month`
        }
    ...
    waste_generated_emissionsDetailsEmssion: async (facilities, year, finalyeardata) => {
        ...
        if (finalyeardata === '2') {
            where += ` AND A.month IN ("Apr","May","Jun","July","Aug","Sep","Oct","Nov","Dec","Jan","Feb","Mar")`;
        } else {
            where += ` AND A.month IN ("Jan","Feb","Mar","Apr","May","Jun","July","Aug","Sep","Oct","Nov","Dec")`;
        }
