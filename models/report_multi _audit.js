...
module.exports = {
  ...
  getStationaryCombustionReportMultiAudit: async (facility, year, month) => {
    return db.query(` select 'Scope1' as scope, 'Stationary Combustions' as category, scsd.Item as DataPoint1, TypeName as DataPoint2,  scef.kgCO2e_kg, scef.kgCO2e_kwh, scef.kgCO2e_litre, scef.kgCO2e_tonnes, \
  ...
  getOtherTransportReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope3' as scope, 'Other Modes of Transport' as category, omot.mode_of_trasport as DataPoint1, omot.type as DataPoint2, omotef.ef as emission_factor, 'kgCO2e_kg' as emission_factor_name, \
  ...
  getSoldProductReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope3' as scope, 'Sold Products' as category, scsd.Item as DataPoint1, spcef.item as DataPoint2,spcef.tonnes, spcef.kg, spcef.litres,  \
                     sum(spc.emission) as Emission,  spc.year as Years, spc.month as Months, spcef.reference,  \
  ...
  getEndOfLifeTreatmentReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope3' as scope, 'End of Life Treatment' as category, ewt.type as DataPoint1, elc.subcategory as DataPoint2, ewt.kg, ewt.tonnes, ewt.litres,  \
                     sum(elc.emission) as Emission,  elc.year as Years, elc.month as Months, ewt.reference,  \
  ...
  getProOfSoldGoodsReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope3' as scope, 'Processing of Sold Products' as category, pspc.intermediate_category as DataPoint1, pspc.processing_acitivity as DataPoint2, pspc.unit,  pspef.efkgco2_kg,  efkgco2_inr,   efkgco2_litres,  efkgco2_tonnes,   \
                     sum(pspc.emission) as Emission,  pspc.year as Years, pspc.month as Months, pspef.reference,  \
  ...
  getRefrigerantReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope1' as scope, 'Refrigerants' as category, scsd.Item as DataPoint1, re.Item as DataPoint2, dbr.Unit, dbr.kgCO2e_kg as emission_factor, 'kgCO2e_kg' as emission_factor_name,  \
  ...
  getFireExtinguisherReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope1' as scope, 'Fire Extinguisher' as category, scsd.Item as DataPoint1, fire.Item as DataPoint2, fire.Unit , fire.kgCO2e_kg as emission_factor, 'kgCO2e_kg' as emission_factor_name,   \
  ...
  getHeatandSteamReportMultiAudit: async (facility, year, month) => {
    return db.query(`select 'Scope1' as scope, scsd.Item as category, hns.Item as DataPoint1, hns.Unit, hns.kgCO2e_kwh as emission_factor, 'kgCO2e_kwh' as emission_factor_name,\
