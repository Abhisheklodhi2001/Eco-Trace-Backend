...
exports.Addelectricity = async (req, res) => {
  try {
    ...
    if (result.error) {
      ...
      const refunit = await getelectricityef(SubCategorySeedID, RegionID, countrydata[0].CountryId);

      const refunit1 = await getelectricityefScop3(SubCategorySeedID, countrydata[0].CountryId);
